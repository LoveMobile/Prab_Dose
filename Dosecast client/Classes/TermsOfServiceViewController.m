...
- (void)viewDidLoad {
    [super viewDidLoad];
	self.title = NSLocalizedStringWithDefaultValue(@"ViewTermsOfServiceTitle", @"Dosecast-client", [NSBundle mainBundle], @"Terms of Service", @"The title on the terms of service view"]);

    self.edgesForExtendedLayout = UIRectEdgeNone;
    self.automaticallyAdjustsScrollViewInsets = NO;

    NSString* regularTerms = NSLocalizedStringWithDefaultValue(@"ViewTermsOfServiceTerms", @"Dosecast-client", [NSBundle mainBundle], @"", @"The privacy policy");
    NSString* groupTerms = NSLocalizedStringWithDefaultValue(@"ViewTermsOfServiceTermsGroup", @"Dosecast-client", [NSBundle mainBundle], @"", @"The privacy policy");
